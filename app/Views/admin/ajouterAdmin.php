...
<div class="card container-fluid border border-secondary bg-success bg-opacity-25 bg-gradient rounded-3 p-2 col-12 mt-5">
    ...
    <!-- Card body -->
    <div class="card-body">
        <form action="/admin/gereradministrateur/ajouterAdmin" method="post">
            <div class="mb-3">
                <label for="pseudoAdmin" class="col-form-label text-light">Pseudo : </label>
                <input type="text" name="pseudoAdmin" id="pseudoAdmin" class="form-control text-bg-dark fs-4" required>
            </div>
            <div class="mb-3">
                <label for="nomAdmin" class="col-form-label text-light">Nom : </label>
                <input type="text" name="nomAdmin" id="nomAdmin" class="form-control text-bg-dark fs-4" required>
            </div>
            <div class="mb-3">
                <label for="prenomAdmin" class="col-form-label text-light">Prenom : </label>
                <input type="text" name="prenomAdmin" id="prenomAdmin" class="form-control text-bg-dark fs-4" required>
            </div>
            <div class="mb-3">
